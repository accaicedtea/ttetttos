 ...
 *
 * Originale: due file separati (ConfirmModal.java +
 * ConfirmModalController.java)
    ...
    public static void show(StackPane parent, String title, String message, Runnable onConfirm) {
        ...
        try {
            ...
            if (ctrl.cancelBtn != null)
                ctrl.cancelBtn.setOnAction(e -> parent.getChildren().remove(node));
            if (ctrl.confirmBtn != null)
                ctrl.confirmBtn.setOnAction(e -> {
                    parent.getChildren().remove(node);
                    if (onConfirm != null)
                        onConfirm.run();
                });

            if (ctrl.titleLabel != null)
                ctrl.titleLabel.setText(title);
            if (ctrl.msgLabel != null)
