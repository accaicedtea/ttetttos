...
public final class ModalButton {
    ...
    public static ModalButton primary(String label, Runnable action) {
        return new ModalButton(label, Style.PRIMARY, action, true);
    }

    public static ModalButton danger(String label, Runnable action) {
        return new ModalButton(label, Style.DANGER, action, true);
    }

    public static ModalButton success(String label, Runnable action) {
        return new ModalButton(label, Style.SUCCESS, action, true);
    }

    public static ModalButton ghost(String label, Runnable action) {
        return new ModalButton(label, Style.GHOST, action, true);
    }

    public static ModalButton warning(String label, Runnable action) {
        return new ModalButton(label, Style.WARNING, action, true);
    }

    /** Bottone che chiude il modal senza eseguire azioni. */
    public static ModalButton cancel(String label) {
        return new ModalButton(label, Style.GHOST, null, true);
    }

    /**
     * Bottone che esegue l'azione ma NON chiude il modal (es. validazione in
     * corso).
     */
