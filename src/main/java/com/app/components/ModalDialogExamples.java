 ...
 * ─────────────────────────────────────────────────────────────────
 *
 *   ModalDialog.success(rootPane, "Salvato!", "Le modifiche sono state applicate.", 2500);
 *
 * ─────────────────────────────────────────────────────────────────
 ...
 *       saving.dismiss();
 *       ModalDialog.success(rootPane, "Ordine #" + orderNumber, "Buon appetito!", 3000);
 *       Navigator.goTo(Navigator.Screen.CONFIRM, orderNumber);
 *   });
 */
public final class ModalDialogExamples {
    private ModalDialogExamples() {} // solo documentazione
}
