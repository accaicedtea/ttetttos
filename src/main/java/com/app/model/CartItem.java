...
public class CartItem {
    ...
    public double totalPrice() {
        return Math.round(priceVal * qty.get() * 100.0) / 100.0;
    }
    ...
    public static final class Builder {
        ...
        public Builder allergens(List<String> al) {
            if (al != null)
                this.allergens = al;
            return this;
        }

        public Builder ingredienti(List<String> v) {
            this.ingredienti = v;
            return this;
        }
