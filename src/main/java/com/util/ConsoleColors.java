...
public class ConsoleColors {
    ...
    public static void printTitle(String msg) {
        System.out.println(PURPLE_BOLD + msg + RESET);
    }
    ...
    public static void sectionStart(String titolo) {
        System.out.println();
        System.out.println(PURPLE_BOLD + "==================== INIZIO ======================" + RESET);
        System.out.println(CYAN_BOLD + " " + titolo + RESET);
        System.out.println(PURPLE_BOLD + "==================================================" + RESET);
    }

    public static void sectionEnd() {
        System.out.println(PURPLE_BOLD + "===================== FINE =======================" + RESET);
        System.out.println();
    }
}
